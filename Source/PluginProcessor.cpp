...
parameters(*this, nullptr, "ParameterTree", {
    ...
    std::make_unique<juce::AudioParameterFloat>("synth_oscSelect" ,"Tomato Colour", 1.0f, 3.0f, 2.0f),
    std::make_unique<juce::AudioParameterFloat>("synth_Envelope" ,"Tomato Shape", 0.01f, 0.99f, 0.1f),
    std::make_unique<juce::AudioParameterFloat>("synth_Volume_Threshold" ,"Tomato Ripeness", juce::NormalisableRange<float>(0.01f, 0.90f, 0.01f, 0.35), 0.2f),
